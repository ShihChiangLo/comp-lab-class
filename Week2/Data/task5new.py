...
helix = md.compute_dssp(t2, simplified=True)
helix = helix.tolist()
splitedhelix = helix[0]

print(splitedhelix)
counth = 0
for i in splitedhelix:
    if i == 'H':
        counth += 1
print('number of helical residues: %s' %counth)



Path = '/Users/shihchianglo/coding/comp-lab-class/Week2/results/Q5/outputforQ5.txt'
f = open(Path, 'w')
...
f.write('Number of helical residues in the protein: '+ str(counth))
f.close()
